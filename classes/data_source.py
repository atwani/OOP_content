...
class Lesson(Data):
        ...
        for _, row in df.iterrows():
            ...
            for i in range(int(len(parts)/2)):
                ...
                if current_view == 'Start':
                    current_view = new_view
                elif current_view == 'Defination of a class' and new_view == 'Object defination':
                    current_view = 'Object defination'
                elif current_view == 'Object defination' and new_view == 'Defination':
                    current_view = 'Defination of a class'
                elif current_view == 'Object defination' and new_view == 'Components of a class':
                    current_view = 'Components of a class'
                elif current_view == 'Components of a class' and new_view == 'Class implementation':
                    current_view = 'Class implementation'
                    #elif current_view == 'Pro' and new_view == 'Pro':
                       # current_view = 'Pro'
    ...
    def get_arguments(self, argument,stance):
        ...
        for subargument in list_of_arguments:
            ...
            argument_df2 = argument_df2[argument_df2['topic']=='Defination of a class']
            # Add these to the arguments.
            argument_df = pd.concat([argument_df,argument_df2])
